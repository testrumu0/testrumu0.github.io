...
%>
    <div class="wrap">
      ...
      <form action="check_insert.jsp" method="post">
       <table>
           <tr>
              <td >제목</td>
              <td><input type="text" name="check_title" maxlength="10" value=""></td>
           </tr>
           <tr>
                <td>작성일시</td>
                <td>
           ...
           <tr>
              <td >내용</td>
              <td><textarea name="check_content" cols="19" rows="5"></textarea></td>
           </tr>
       </table>
           <br>
          <div align="center">
