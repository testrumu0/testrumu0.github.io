...
%>
   <div class="wrap">
      <h3 class="header"><%=suserid%>님 "Hey!캘린더"에 일정을 기록하세요</h3><br>
       <form name="wirte_form" action="schedule_insert.jsp" method="post">
        <table>
            <tr>
                <td>제목</td>
                <td><input type="text" name="sch_title" maxlength="80" value=""></td>
            </tr>
            <tr>
                <td>날짜선택</td>
                <td>
            ...
            <tr>
                <td>내용</td>
                <td><textarea name="sch_content" cols="80" rows="5"></textarea></td>
            </tr>
        </table>
        <br>
        <div align="center">
            <input type="submit" value="저장">
            <input type="button" value="취소" onclick="location.href='schedule_li.jsp' ">
        </div>    
    </form>
