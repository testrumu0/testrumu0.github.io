...
function cartAdd() {
	...
	if (document.frm1.sizecd.value == "크기선택이 필요하지 않습니다.")
	{
		document.frm1.sizecd.value = "";
		return false;
	}
...
*/
	...
	if (document.frm1.sizecd.value == "크기선택이 필요하지 않습니다.")
	{
		document.frm1.sizecd.value = "N";
		return false;
	}


	document.frm1.action = "mypage_insert.jsp";
	document.frm1.submit();
}
...
{	
		...
		String bed = goodscd.substring(1,2);
            ...
            <td colspan="2" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <div name="colorcd" id="colorcd">
												...
												/*while (rs2.next()){
													...
													while(rs2.next()){
														...
														String color = rs2.getString("colornm");
												%>
												
									<input type="radio" name="colorcd" value ="<%=rs2.getString("colorcd")%>"><%=color%>&nbsp;&nbsp;<img src="images/<%=color%>.jpg"><br>
									<%
										}
									%>
                      </div>
                    ...
                    <td class="line">
                      ...
                      <select name="sizecd" id="sizecd">
						   ...
						   %>
										...
										%>
										<OPTION VALUE="">크기선택이 필요하지 않습니다.</OPTION>
											<%
											}
											%>
              ...
              <tr>
                <td align="center">
				  ...
				  <input type = "button" id = "button3"  value = "위시리스트 담기" onClick = "wishAdd();"/>
