...
{
	document.frm1.action = "boardAmodify_ok.jsp";
...
try
{
	...
	String strSQL = "SELECT num, title, contents, writer FROM boardA WHERE num = ?";
	pstmt = con.prepareStatement(strSQL);
	pstmt.setInt(1, num);
	rs = pstmt.executeQuery();

	if (rs.next() == false)
		out.print("등록된 공지가 없습읍니다.");
	else
	{
	...
	%>
		...
		<h3>공지사항 수정</h3>
		<BODY>
		<FORM NAME = "frm1" ACTION = "boardAmodify_ok.jsp" METHOD = "post">
