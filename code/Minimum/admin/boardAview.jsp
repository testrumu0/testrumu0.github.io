...
{
	document.frm1.action = "boardAmodify.jsp";
	document.frm1.submit();
}

function submit_delete()
{
	document.frm1.action = "boardAdelConfirm.jsp";
	document.frm1.submit();
}
...
try
{
	...
	String strSQL = "SELECT num, title, contents, writer, CONVERT(CHAR(10), updatedtm, 120) writedt, readcnt FROM boardA WHERE num = ?";
	...
	else
	{
		...
		strSQL = "UPDATE boardA SET readcnt = readcnt + 1 WHERE num = ?";
		pstmt = con.prepareStatement(strSQL);
		pstmt.setInt(1, num);
		pstmt.executeUpdate();
